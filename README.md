# genpark-pre-purchase-return-fraud-propensity-scorer-skill
...
**genpark-pre-purchase-return-fraud-propensity-scorer-skill** is a deterministic, zero-dependency Python skill engineered for intelligent merchant operations, supply chain logistics routing, and customer retention analytics.

> **Executive Capability**: Pre-purchase return fraud propensity & wardrobing scorer (Gorgias / Yotpo)
...
result = client.score_return_fraud_risk()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-pre-purchase-return-fraud-propensity-scorer-skill": {
      "command": "python",
      "args": ["/path/to/genpark-pre-purchase-return-fraud-propensity-scorer-skill/mcp_server.py"]
    }
  }
}
```
